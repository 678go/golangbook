...
func (c *helloServiceClient) Hello(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
...
func (x *helloServiceChannelClient) Recv() (*Reply, error) {
	m := new(Reply)
...
func (UnimplementedHelloServiceServer) Hello(context.Context, *Request) (*Reply, error) {
...
func (x *helloServiceChannelServer) Send(m *Reply) error {
